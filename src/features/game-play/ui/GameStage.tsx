		...
		return (
			<div className="flex items-center justify-center h-full p-4 md:p-6">
				<div className="text-center space-y-6">
					<p className="chalk-text text-chalk-yellow text-xl md:text-2xl">모든 라운드 완료! 🎉</p>

					<div className="flex flex-col gap-3">
						<ChalkButton variant="yellow" onClick={resetGame} className="px-6 py-3 text-lg">
							처음부터 다시하기
						</ChalkButton>
						...
						<a href="/">
							<ChalkButton variant="white" className="px-6 py-3 text-lg w-full">
								홈으로 돌아가기
							</ChalkButton>
						</a>
					</div>
