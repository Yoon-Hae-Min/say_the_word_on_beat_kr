					...
					<div className="space-y-8 text-chalk-white">
						...
						<section>
							...
							<p className="leading-relaxed text-sm md:text-base">
								본 약관은 단어리듬게임(이하 "서비스")의 이용과 관련하여 서비스 제공자와 이용자의
						...
						<section>
							...
							<ul className="list-disc list-inside space-y-2 leading-relaxed text-sm md:text-base">
								<li>
									<strong>"서비스"</strong>란 단어리듬게임 웹사이트를 통해 제공되는 리듬 퀴즈 챌린지
									생성 및 플레이 서비스를 말합니다.
								</li>
								<li>
								...
								<li>
									<strong>"콘텐츠"</strong>란 이용자가 서비스에 업로드한 이미지, 텍스트 등 모든
									정보를 말합니다.
								</li>
								<li>
						...
						<section>
							...
							<ul className="list-decimal list-inside space-y-2 leading-relaxed text-sm md:text-base">
								...
								<li>
									서비스 제공자는 필요한 경우 본 약관을 변경할 수 있으며, 변경된 약관은 서비스
									화면에 공지함으로써 효력을 발생합니다.
								</li>
						...
						<section>
							...
							<ul className="list-decimal list-inside space-y-2 leading-relaxed text-sm md:text-base ml-4">
								<li>
									서비스용 설비의 보수, 점검, 교체 또는 고장, 통신두절 등의 사유가 발생한 경우
								</li>
						...
						<section>
							...
							<ul className="list-decimal list-inside space-y-2 leading-relaxed text-sm md:text-base">
								...
								<li>
									이용자는 서비스에 콘텐츠를 업로드함으로써 서비스 제공자에게 해당 콘텐츠를 서비스
									제공 목적으로 사용할 수 있는 권한을 부여합니다.
								</li>
								<li>
									이용자가 '공개' 설정으로 생성한 챌린지는 서비스를 이용하는 다른 모든 이용자에게
									공개되며, 누구나 해당 챌린지를 조회하고 플레이할 수 있습니다.
								</li>
								<li>
									공개 챌린지에 포함된 이미지, 텍스트 등의 콘텐츠는 제3자에게 노출될 수 있으므로,
									이용자는 개인정보, 저작권 침해 콘텐츠, 부적절한 콘텐츠 등을 업로드하지 않도록
									주의해야 합니다.
								</li>
								<li>
									서비스 제공자는 본 약관 제6조를 위반하는 콘텐츠에 대해 사전 통보 없이 삭제할 수
									있습니다.
								</li>
								<li>
									이용자가 업로드한 콘텐츠로 인해 발생하는 모든 법적 책임은 해당 이용자에게
									있습니다.
								</li>
							</ul>
						</section>
						...
						<section>
							...
							<p className="leading-relaxed text-sm md:text-base">
								서비스 제공자는 이용자의 개인정보를 보호하기 위해 노력합니다. 개인정보의 수집, 이용,
								보관, 파기 등에 관한 사항은{" "}
								<Link href="/privacy" className="text-chalk-yellow hover:underline font-bold">
									개인정보 처리방침
								</Link>
								에 따릅니다.
							</p>
						...
						<section>
							...
							<ul className="list-decimal list-inside space-y-2 leading-relaxed text-sm md:text-base">
								...
								<li>
									이용자는 서비스를 이용함으로써 얻은 정보를 서비스 제공자의 사전 승낙 없이 복제,
									송신, 출판, 배포, 방송 등 기타 방법으로 이용하거나 제3자에게 이용하게 하여서는 안
									됩니다.
								</li>
							</ul>
						</section>
						...
						<section>
							...
							<ul className="list-decimal list-inside space-y-2 leading-relaxed text-sm md:text-base">
								<li>
									서비스 제공자는 천재지변, 전쟁, 기간통신사업자의 서비스 중지 등 불가항력적인
									사유로 서비스를 제공할 수 없는 경우 책임이 면제됩니다.
								</li>
								<li>
									서비스 제공자는 이용자의 귀책사유로 인한 서비스 이용 장애에 대하여 책임을 지지
									않습니다.
								</li>
								<li>
									서비스 제공자는 이용자가 서비스를 통해 얻은 정보 또는 자료의 신뢰도, 정확성 등에
									대해서는 책임을 지지 않습니다.
								</li>
								<li>
									서비스 제공자는 이용자 간 또는 이용자와 제3자 간에 서비스를 매개로 발생한 분쟁에
						...
						<section>
							...
							<ul className="list-decimal list-inside space-y-2 leading-relaxed text-sm md:text-base">
								<li>
									서비스 제공자와 이용자는 서비스와 관련하여 발생한 분쟁을 원만하게 해결하기 위하여
									필요한 모든 노력을 하여야 합니다.
								</li>
								<li>
									제1항의 노력에도 불구하고 분쟁이 해결되지 않을 경우, 양 당사자는 민사소송법상의
									관할법원에 소를 제기할 수 있습니다.
								</li>
							</ul>
						</section>
