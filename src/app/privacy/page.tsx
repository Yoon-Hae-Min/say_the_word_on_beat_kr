				...
				<div className="mx-auto max-w-4xl">
					...
					<div className="mb-8 text-center">
						<p className="text-chalk-white/90 leading-relaxed">
							단어리듬게임은 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이
							정한 바를 준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 이에
							「개인정보 보호법」 제30조에 따라 정보주체에게 개인정보 처리에 관한 절차 및 기준을
							안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과
					...
					<div className="chalk-border chalk-dust border-chalk-blue bg-chalkboard-bg/80 p-6 md:p-8 space-y-8">
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 서비스 제공을 위하여 필요한 최소한의 개인정보를 수집하고 있습니다.
							...
							<ul className="list-disc list-inside text-chalk-white/90 space-y-1 ml-4">
								<li>서비스 제공: 챌린지 생성 및 공유 서비스 제공, 게임 플레이 기능 제공</li>
								<li>서비스 개선: 신규 서비스 개발, 맞춤 서비스 제공, 통계 분석</li>
							</ul>
						</section>
						...
						<section>
							...
							<div className="bg-chalkboard-bg/50 p-4 rounded-md mb-4">
								<p className="text-chalk-yellow font-bold mb-2">[자동 수집 항목]</p>
								<ul className="list-disc list-inside text-chalk-white/90 space-y-1 ml-4">
							...
							<p className="text-chalk-white/90 leading-relaxed">
								단어리듬게임은 별도의 회원가입 없이 사용 가능하며, 개인을 식별할 수 있는 정보(이름,
								이메일, 전화번호 등)를 수집하지 않습니다.
							</p>
						</section>
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 원활한 업무 처리를 위해서 개인정보 처리업무를 다음과 같이 위탁하여
								처리하고 있습니다.
							</p>

							<div className="bg-chalkboard-bg/50 p-4 rounded-md mb-3">
								<p className="text-chalk-yellow font-bold">수탁자: Supabase Inc.</p>
							...
							<div className="bg-chalkboard-bg/50 p-4 rounded-md mb-4">
								<p className="text-chalk-yellow font-bold">수탁자: Google LLC</p>
								<p className="text-chalk-white/90 mt-1">
							...
							<p className="text-chalk-white/90 leading-relaxed">
								단어리듬게임은 위탁계약 체결 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을
								규정하고 있습니다. 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 사용자의 개인정보를 제3자에게 제공하지 않습니다. 다만, 다음의 경우는
								예외로 합니다:
							</p>
							<ul className="list-disc list-inside text-chalk-white/90 space-y-1 ml-4">
								<li>사용자가 공개 챌린지로 설정하여 다른 사용자에게 공유하는 경우</li>
								<li>
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게
								되었을 때에는 지체없이 해당 개인정보를 파기합니다.
							</p>
							<div className="bg-chalkboard-bg/50 p-4 rounded-md mb-3">
								<p className="text-chalk-yellow font-bold mb-2">파기 절차</p>
								<p className="text-chalk-white/90">
									사용자가 챌린지 삭제를 요청하는 경우, 관련된 모든 데이터(이미지 파일 포함)는 내부
									방침 절차에 의해 지체 없이 파기합니다.
								</p>
							</div>
						...
						<section>
							...
							<ul className="list-disc list-inside text-chalk-white/90 space-y-2 ml-4">
								<li>
									정보주체는 단어리듬게임에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의
									권리를 행사할 수 있습니다.
								</li>
								<li>
									권리 행사는 단어리듬게임에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라
									개인정보 보호책임자에게 서면, 전자우편 등을 통하여 하실 수 있으며, 단어리듬게임은
									이에 대해 지체없이 조치하겠습니다.
								</li>
								<li>
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
							</p>
							<div className="bg-chalkboard-bg/50 p-4 rounded-md mb-3">
								<p className="text-chalk-yellow font-bold mb-2">관리적 조치</p>
								<p className="text-chalk-white/90">개인정보 취급 담당자 지정 및 최소화</p>
							</div>
							<div className="bg-chalkboard-bg/50 p-4 rounded-md">
								<p className="text-chalk-yellow font-bold mb-2">기술적 조치</p>
								<p className="text-chalk-white/90">
									개인정보처리시스템 등의 접근권한 관리, 접근통제시스템 설치, 개인정보의 암호화,
									보안프로그램 설치
								</p>
							</div>
						</section>
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고
							...
							<div className="bg-chalkboard-bg/50 p-4 rounded-md mb-3">
								<p className="text-chalk-yellow font-bold mb-2">쿠키의 사용 목적</p>
								<ul className="list-disc list-inside text-chalk-white/90 space-y-1 ml-4">
							...
							<div className="bg-chalkboard-bg/50 p-4 rounded-md mb-3">
								<p className="text-chalk-yellow font-bold mb-2">쿠키의 설치·운영 및 거부</p>
								<p className="text-chalk-white/90 mb-2">
									웹브라우저 상단의 도구 &gt; 인터넷 옵션 &gt; 개인정보 메뉴의 옵션 설정을 통해 쿠키
									저장을 거부할 수 있습니다.
								</p>
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								단어리듬게임은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한
								정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를
								지정하고 있습니다.
							</p>
							<div className="bg-chalkboard-bg/50 p-4 rounded-md">
								<p className="text-chalk-yellow font-bold mb-2">개인정보 보호책임자</p>
							...
							<p className="text-chalk-white/90 mt-4 leading-relaxed">
								정보주체는 단어리듬게임의 서비스를 이용하시면서 발생한 모든 개인정보보호 관련 문의,
								불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자로 문의할 수 있습니다.
								단어리듬게임은 정보주체의 문의에 대해 지체없이 답변 및 처리해드릴 것입니다.
							</p>
						</section>
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								...
								있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기
								바랍니다.
							</p>
							<ul className="list-disc list-inside text-chalk-white/90 space-y-2 ml-4">
								<li>
						...
						<section>
							...
							<p className="text-chalk-white/90 leading-relaxed mb-4">
								이 개인정보 처리방침은 2025년 1월 1일부터 적용됩니다. 법령, 정책 또는 보안기술의
								변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 변경사항 시행 전에 웹사이트를
								통해 공지하도록 하겠습니다.
							</p>
							<div className="bg-chalkboard-bg/50 p-4 rounded-md">
								<p className="text-chalk-white/70 text-sm">
